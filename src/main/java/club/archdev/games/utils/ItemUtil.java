...
public final class ItemUtil {
    ...
    public static ItemStack createNoFlagsItem(Material material, String name, int amount, short damage) {
        ...
        item.setItemMeta(meta);
        meta.spigot().setUnbreakable(true);
        meta.addItemFlags(new ItemFlag[] { ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_UNBREAKABLE, ItemFlag.HIDE_POTION_EFFECTS, ItemFlag.HIDE_UNBREAKABLE, ItemFlag.HIDE_ATTRIBUTES });
        item.setItemMeta(meta);
        return item;
    }
